...
urlpatterns = (
    ...
    path("node-sids/import/", views.NodeSIDImportView.as_view(), name="nodesid_import"),
    ...
    path("node-sids/delete/", views.NodeSIDBulkDeleteView.as_view(), name="nodesid_bulk_delete"),
    path(
